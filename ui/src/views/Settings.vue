  ...
  data() {
    return {
      ...
      erpNextModules: [
        ...
        {
          label: "Nl Attendance Timesheet",
          value: "nl_attendance_timesheet",
          name: "nl-attendance-timesheet",
          disabled: false,
        },
        {
          label: "Nl Piece Rate Pay",
          value: "nl_piece_rate_pay",
        ...
        {
          label: "Mpesa B2C",
          value: "navari_mpesa_b2c",
          name: "navari-mpesa-b2c",
          disabled: false,
        },
        {
